...
insert into application(id, version, title, abstract, keywords, author, magazine, field, file, state, accepted, timestamp) values (2, 0, 'Okeansko dno', 'O značaju i veličini okeanskog dna', 'okean,dno,Pacifik,Mont Everest,Mauna Kea,Marijanski rov,kontinent,voda', 'ppetrovic', '12345678', 'GLG', 'C:\\Users\\kosti\\git\\science-journal-center\\science-journal\\target\\www\\upload-dir\\12345678\\applications\\2-Okeansko dno.pdf', 'MINOR_PAPER_CORRECTION', 1, '2019-01-27');
insert into application_coauthors(paper, author) values (2, 1);
--insert into paper(doi, title, abstract, keywords, author, issue, field, file, price, currency, last_revision_id) values ('10101011', 'Okeansko dno', 'O značaju i veličini okeanskog dna', 'okean,dno,Pacifik,Mont Everest,Mauna Kea,Marijanski rov,kontinent,voda', 'ppetrovic', 2, 'GLG', 'C:\\Users\\kosti\\git\\science-journal-center\\science-journal\\target\\www\\upload-dir\\12345678\\applications\\2-Okeansko dno.pdf', 0, 'RSD', 2);
--insert into paper_coauthors(paper, author) values ('10101011',1);
...
insert into application(id, version, title, abstract, keywords, author, magazine, field, file, state, accepted, timestamp) values (3, 0, 'Svet u doba Krede', 'O dinosaurusima koji su vladali u doba Krede', 'dinosaurus,Kreda,Pangea,Laurazija,Gondvana,Jura,Brachiosaurus,Apatosaurus,Hypsilophodon,klima,biljke', 'mmarkovic', '12345678', 'PLN', 'C:\\Users\\kosti\\git\\science-journal-center\\science-journal\\target\\www\\upload-dir\\12345678\\applications\\3-Svet u doba Krede.pdf', 'REVIEW_ANALYSIS', 1, '2019-01-27');
insert into application_coauthors(paper, author) values (3, 2);
--insert into paper(doi, title, abstract, keywords, author, issue, field, file, price, currency, last_revision_id) values ('10101111', 'Svet u doba Krede', 'O dinosaurusima koji su vladali u doba Krede', 'dinosaurus,Kreda,Pangea,Laurazija,Gondvana,Jura,Brachiosaurus,Apatosaurus,Hypsilophodon,klima,biljke', 'mmarkovic', 2, 'PLN', 'C:\\Users\\kosti\\git\\science-journal-center\\science-journal\\target\\www\\upload-dir\\12345678\\applications\\3-Svet u doba Krede.pdf', 0, 'RSD', 3);
--insert into paper_coauthors(paper, author) values ('10101111',2);
...
insert into application(id, version, title, abstract, keywords, author, magazine, field, file, state, accepted, timestamp) values (4, 0, 'Zečevi i kunići', 'O najbitnijim karakteristikama lagomorfa', 'zec,kunic,lagomorfe,sisari,glodari,zvizdare', 'mmarkovic', '87654321', 'ZOO', 'C:\\Users\\kosti\\git\\science-journal-center\\science-journal\\target\\www\\upload-dir\\87654321\\applications\\4-Zečevi i kunići.pdf', 'REVIEW_ANALYSIS', 1, '2019-01-27');
insert into application_coauthors(paper, author) values (4, 2);
insert into paper(doi, title, abstract, keywords, author, issue, field, file, price, currency, last_revision_id) values ('10111111', 'Zečevi i kunići', 'O najbitnijim karakteristikama lagomorfa', 'zec,kunic,lagomorfe,sisari,glodari,zvizdare', 'mmarkovic', 3, 'ZOO', 'C:\\Users\\kosti\\git\\science-journal-center\\science-journal\\target\\www\\upload-dir\\87654321\\applications\\4-Zečevi i kunići.pdf', 100, 'RSD', 4);
insert into paper_coauthors(paper, author) values ('10111111',2);
...
insert into application(id, version, title, abstract, keywords, author, magazine, field, file, state, accepted, timestamp) values (5, 0, 'Koža', 'O najbitnijim karakteristikama kože', 'koza,omotac,stopala,kapci,dlacice,cula,znoj', 'mmarkovic', '87654321', 'ANA', 'C:\\Users\\kosti\\git\\science-journal-center\\science-journal\\target\\www\\upload-dir\\87654321\\applications\\5-Koža.pdf', 'REVIEW_ANALYSIS', 1, '2019-01-27');
insert into application_coauthors(paper, author) values (5, 2);
insert into application_coauthors(paper, author) values (5, 1);
--insert into paper(doi, title, abstract, keywords, author, issue, field, file, price, currency, last_revision_id) values ('11111111', 'Koža', 'O najbitnijim karakteristikama kože', 'koza,omotac,stopala,kapci,dlacice,cula,znoj', 'mmarkovic', 3, 'ANA', 'C:\\Users\\kosti\\git\\science-journal-center\\science-journal\\target\\www\\upload-dir\\87654321\\applications\\5-Koža.pdf', 300, 'RSD', 5);
--insert into paper_coauthors(paper, author) values ('11111111',2);
--insert into paper_coauthors(paper, author) values ('11111111',1);
...
insert into application(id, version, title, abstract, keywords, author, magazine, field, file, state, accepted, timestamp) values (6, 0, 'Mongoli', 'O kulturnom nasleđu Mongola', 'mongoli,konjanici,Jurta,srednja Azija,nomadi,Gobi', 'ppetrovic', '87654321', 'HIS', 'C:\\Users\\kosti\\git\\science-journal-center\\science-journal\\target\\www\\upload-dir\\87654321\\applications\\6-Mongoli.pdf', 'REVIEW_ANALYSIS', 1, '2019-01-27');
insert into application_coauthors(paper, author) values (6, 2);
insert into application_coauthors(paper, author) values (6, 1);
--insert into paper(doi, title, abstract, keywords, author, issue, field, file, price, currency, last_revision_id) values ('11111110', 'Mongoli', 'O kulturnom nasleđu Mongola', 'mongoli,konjanici,Jurta,srednja Azija,nomadi,Gobi', 'ppetrovic', 4, 'HIS', 'C:\\Users\\kosti\\git\\science-journal-center\\science-journal\\target\\www\\upload-dir\\87654321\\applications\\6-Mongoli.pdf', 200, 'RSD', 6);
--insert into paper_coauthors(paper, author) values ('11111110',2);
--insert into paper_coauthors(paper, author) values ('11111110',1);
